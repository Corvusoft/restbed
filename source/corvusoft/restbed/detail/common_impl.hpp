...
#ifndef _RESTBED_DETAIL_COMMON_IMPL_H
#define _RESTBED_DETAIL_COMMON_IMPL_H 1
    ...
    namespace detail
    {
        ...
        class CommonImpl
        {
            ...
            private:
                ...
                //Constructors
                CommonImpl( void ) = delete;
                
                CommonImpl( const CommonImpl& original ) = delete;
                
                virtual ~CommonImpl( void ) = delete;
                ...
                //Operators
                CommonImpl& operator =( const CommonImpl& value ) = delete;
...
#endif  /* _RESTBED_DETAIL_COMMON_IMPL_H */
