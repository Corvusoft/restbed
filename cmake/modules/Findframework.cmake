...
if ( framework_SOURCE )
    ...
    ExternalProject_Add( corvusoft-framework SOURCE_DIR ${framework_SOURCE}
    ...
    add_library( framework SHARED IMPORTED )
    set_target_properties( framework PROPERTIES IMPORTED_LOCATION ${framework_LIBRARY} )
